...
public interface IColaboradorService
{
    ...
    /// <summary>
    /// Cadastra um novo colaborador após validação de CPF, email, senha e a aplicação de hash Argon2id.
    /// </summary>
    ...
    /// <summary>
    /// Obtém colaboradores filtrando pelo cargo/tipo (ex: Instrutor, Atendente, etc.).
    /// </summary>
