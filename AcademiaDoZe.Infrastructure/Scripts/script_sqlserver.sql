...
BEGIN
    CREATE TABLE tb_colaborador (
        ...
        vinculo INT NOT NULL, -- Enum ColaboradorVinculo (0=CLT, 1=Estagio)
...
BEGIN
    CREATE TABLE tb_matricula (
        ...
        restricao_medica INT NOT NULL CONSTRAINT DF_tb_matricula_restricoes DEFAULT 0, -- Enum [Flags] MatriculaRestricoes
